// Transparent shader is based on a shader made by Amir Abiri, generously donated to the Public Domain (I confirmed)
...
Shader "Cubemapper/Transparent/Transparent Diffuse" {
Properties {
